...
public class QDeduction extends EntityPathBase<Deduction> {
	...
	public StringPath getConsumptionUrl() {
		return consumptionUrl;
	}

	public StringPath getDeductioinCode() {
		return deductioinCode;
	}

	public NumberPath<Integer> getDeductionModelId() {
		return deductionModelId;
	}

	public DateTimePath<java.util.Date> getDueTime() {
		return dueTime;
	}

	public NumberPath<Integer> getHourNum() {
		return hourNum;
	}
	...
	public NumberPath<Integer> getParkingUserId() {
		return parkingUserId;
	}

	public DateTimePath<java.util.Date> getReceiveTime() {
		return receiveTime;
	}
	...
	public DateTimePath<java.util.Date> getUseTime() {
		return useTime;
	}
