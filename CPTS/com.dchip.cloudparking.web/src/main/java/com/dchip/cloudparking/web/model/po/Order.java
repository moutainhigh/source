...
public class Order implements java.io.Serializable {
	...
	public Order(int parkingInfoId, int userId) {
		this.parkingInfoId = parkingInfoId;
		this.userId = userId;
	}

	public Order(BigDecimal fee, Integer type, Integer status, int parkingInfoId, int userId, Date payTime,
			Integer couponId, BigDecimal discountAmount, Integer parkingTime, Integer isTransfer, BigDecimal finalFee,
			String outTradeNo, Integer deductionId, Integer appointmentId, BigDecimal applyCash, Integer staffId) {
		this.fee = fee;
		this.type = type;
		this.status = status;
		this.parkingInfoId = parkingInfoId;
