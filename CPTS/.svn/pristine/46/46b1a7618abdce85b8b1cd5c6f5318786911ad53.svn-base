...
public class FeeServiceKit {
    ...
    public double getResultFee() {
        ...
        //月卡
        if (cardType == BaseConstant.CardType.Month.getTypeValue()) {//全天
        ...
        } else if (cardType == BaseConstant.CardType.WorkDay.getTypeValue()) {//工作日
        ...
        } else if (cardType == BaseConstant.CardType.WorkTime.getTypeValue()) {//工作时
            if (expireDate.after(dateOut)) {//放行
