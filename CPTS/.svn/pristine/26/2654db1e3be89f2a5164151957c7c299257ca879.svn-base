...
import com.dchip.cloudparking.web.model.po.RechargeLog;
...
public class QRechargeLog extends EntityPathBase<RechargeLog> {
	...
	public NumberPath<java.math.BigDecimal> getDiscountMoney() {
	...
	public NumberPath<java.math.BigDecimal> getInMoney() {
		return inMoney;
	}
	...
	public DateTimePath<java.util.Date> getRechargeDate() {
		return rechargeDate;
	}

	public BooleanPath getStatus() {
		return status;
	}
