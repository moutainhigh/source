...
public class QUser extends EntityPathBase<User> {
    ...
    public final StringPath authenticationFailReason = createString("authenticationFailReason");
    ...
    public final NumberPath<Integer> isAuthentication = createNumber("isAuthentication", Integer.class);
