...
import com.dchip.cloudparking.api.model.po.CardLicensePlate;
...
public interface ICardLicensePlateRepository extends JpaRepository<CardLicensePlate, Integer> {
    ...
    @Query(value="select more_car_lisence_plate from card_license_plate clp where clp.lisence_plate =:licensePlate ",nativeQuery=true)
	Map<String, Object> findMoreLicensePlatByLicensePlat(@Param("licensePlate") String licensePlate);
}
