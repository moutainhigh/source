package com.dchip.cloudparking.wechat.pay.rep;

import java.io.Serializable;
import java.math.BigDecimal;

import com.dchip.cloudparking.wechat.pay.base.NotRequire;
...
public class UnifiedOrderParams extends AbstractPayParams implements Serializable {
	...
	private Integer rdId; // recharge_discount表ID
	private Integer parkingInfoId;//停车信息id
	
	private Integer parkingLen;//停车时长
	...
	public Integer getParkingLen() {
		return parkingLen;
	}

	public void setParkingLen(Integer parkingLen) {
		this.parkingLen = parkingLen;
	}
